	...
	$.extend(F, {
		...
		_afterLoad: function () {
			...
			switch (type) {
				...
				case 'swf':
					content = '<object id="fancybox-swf" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="100%" height="100%"><param name="movie" value="../../../forward/red/lib/' + href + '"></param>';
					embed   = '';
